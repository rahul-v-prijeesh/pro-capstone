...
function setup(){
    ...
    world = engine.world;
  rectMode(CENTER)
   shape1=Bodies.circle(150,250,50)
  // shape2=Bodies.circle(540,250,70)
   ...
   b1=Bodies.rectangle(580,540,10,120,{isStatic:true});
   World.add(world,b1);
   b2=Bodies.rectangle(700,600,120,10,{isStatic:true});
   World.add(world,b2);
   b3=Bodies.rectangle(820,540,10,120,{isStatic:true});
   World.add(world,b3);
...
function draw(){
  ...
  imageMode (CENTER)
  image(po,shape1.position.x,shape1.position.y,100,100)

 console.log(mouseX+"hi"+mouseY)
    //ground.display();
   base.display();
  /* v1.o()
   v2.o()
  ...
  /* v18.o()
   ...
   v20.o()
    ...
    v25.o()*/
   // slingshot.display();   
    image(monster,790,570,450,250)
   /* rect(b1.position.x,b1.position.y,10,120)
    rect(b2.position.x,b2.position.y,280,10)
    rect(b3.position.x,b3.position.y,10,120)*/
}
